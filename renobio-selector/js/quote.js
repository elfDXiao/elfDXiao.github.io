...
(function () {
  ...
  var STEPS = [
    ...
    { n: 9, title: 'シャワー', titleZh: '花洒', noteZh: '花洒头（N=细气泡 Eco Aqua Plus／T/C/B=经济淋浴）＋淋浴挂钩·带滑钩扶手杆。', note: 'シャワーヘッド（N=ファインバブル エコアクアPlus／T/C/B=エコフル）＋シャワーフック・スライドフック付握りバー。' },
    { n: 10, title: 'カウンター・照明', titleZh: '台面·照明', noteZh: '易擦洗纤细台面（仅 N/T·700W/600W）＋亚克力化妆架（仅 B）＋照明 6 种＋圆洗面盆（B）。', note: 'とるピカスリムカウンター（N/T のみ・700W/600W）＋アクリル化粧棚（B のみ）＋照明 6 種＋丸形洗面器（B）。' },
    { n: 11, title: 'ミラー', titleZh: '镜子', noteZh: '竖长/普通/宽幅/大型/磁吸镜 8 种＋洁净镜。C 型标准无镜。', note: 'タテ長/ミラー/ワイド/大型/マグネットミラー 8 種＋キレイ鏡。C タイプ標準はミラーなし。' },
    { n: 12, title: '収納・タオル', titleZh: '收纳·毛巾', noteZh: '收纳架 180W（透明/白·2/3层）＋磁吸置物架＋毛巾架。C 型标准无收纳架。', note: '収納棚 180W（クリア/ホワイト・2/3段）＋マグネットシェルフ＋タオル掛。C タイプ標準は収納棚なし。' },
    { n: 13, title: '床高・配管・追いだき', titleZh: '地面·配管·追焚', noteZh: '地面高度（190/230mm ＋¥2,000）＋螺栓脚用粘合剂＋给水给汤配管（A/B/J/P）＋追焚加工 6 种。', note: '床高さ（190/230mm ＋¥2,000）＋ボルト脚用接着剤＋給水給湯配管（A/B/J/P）＋追いだき加工 6 種。' },
