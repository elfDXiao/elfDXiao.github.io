...
assert('P タイプ FRONT_ACCENT ACC_PRE × 周辺HⅡ = +73,500（L1）', Q.contributionFor('wall') === 73500, Q.contributionFor('wall'));
Q.state.sel.type = 'T';
assert('T タイプ FRONT_ACCENT ACC_PRE × 周辺HⅡ = +94,500（L2）', Q.contributionFor('wall') === 94500, Q.contributionFor('wall'));
Q.reset();
Q.state.sel.type = 'P';
Q.state.sub.wall_plan = 'FRONT_ACCENT';
...
assert('P タイプ ACC_BASIC × 周辺BASIC = −21,000（L1柄 EG2J3）', Q.contributionFor('wall') === -21000, Q.contributionFor('wall'));
Q.state.sub.wall_pattern = 'EG2J4';
assert('L2柄 EG2J4 プリエダークグレー × 周辺BASIC = 0（+21,000）', Q.contributionFor('wall') === 0, Q.contributionFor('wall'));
Q.reset();
Q.state.sub.wall_plan = 'FRONT_ACCENT';
Q.state.sel.wall = 'ACC_PRE';
...
assert('4面同色柄 EGAB5 priceByType P=63,000/T=84,000', P.priceFor(Q.cat('wall').options.find(o => o.code === 'EGAB5'), 'P', '1620') === 63000 && P.priceFor(Q.cat('wall').options.find(o => o.code === 'EGAB5'), 'T', '1620') === 84000);
Q.state.sel.type = 'P';
