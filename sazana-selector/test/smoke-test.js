...
Q.reset();
Q.state.sel.wall = 'HⅡ';
Q.state.sub.wall_pattern = 'EGAB5';
assert('HⅡ note 解析柄 ≥ 20', Q.fourSamePatterns('HⅡ').length >= 20, Q.fourSamePatterns('HⅡ').length);
assert('HⅡ 柄 EGAB5 明细含品番', Q.describe('wall').model === 'EGAB5', Q.describe('wall').model);
Q.reset();
Q.state.sel.wall = 'ACC_PRE';
